...
namespace Comp1640_Final.Controllers
{
    ...
    public class ArticlesController : ControllerBase
    {
        ...
        [HttpGet("approved/title/{articleTitle}")]
        public async Task<IActionResult> GetApprovedArticleByTitle(string articleTitle, string userId)
        {
            var currentUser = await _userManager.FindByIdAsync(userId);
            var faculty = currentUser.FacultyId;
        ...
        [HttpGet("guest/approved/title/{articleTitle}")]
        public async Task<IActionResult> GetGuestApprovedArticleByTitle(string articleTitle, string userId)
        {
            var currentUser = await _userManager.FindByIdAsync(userId);
            var faculty = currentUser.FacultyId;
